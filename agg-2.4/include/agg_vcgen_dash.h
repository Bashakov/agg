...
namespace agg
{
	...
	public:
		dash_description();
		const dash_description & operator = (const dash_description & rh);

		void     remove_all_dashes();
		void     add_dash(double dash_len, double gap_len);
		void     dash_start(double ds);
	    unsigned dashes_count() { return m_num_dashes/2; };
    ...
    //
	class vcgen_dash: public dash_description
    {
        enum status_e
        {
            initial,
